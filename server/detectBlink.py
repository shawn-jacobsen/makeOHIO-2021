# detects blink from input feed and POSTS endpoint with data
...
def isTired(blinkRate):
	...
	tired = blinkRate>ABR
	if tired:
		print(requests.get("http://http://192.168.137.176/:5000/tired"))
	return tired
...
while True:
	...
	for i in range(min(max_boxes_to_draw, boxes.shape[0])):
		if scores is None or scores[i] > min_score_thresh:
			print (str(scores[i] * 100) + "%", detections['detection_classes'][i]) # prints confidence scores. class 0 is "blink"
			# 1 is blink
